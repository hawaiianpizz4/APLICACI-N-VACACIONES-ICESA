<?php
require_once('./model/listaSolicitudesxHijo.php');
$usuariosXhijo = listaUsuariosxHijo::listaUsuarioxHijo($_SESSION["nombre"], $_SESSION["apellido"]);
?>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-7">
                            ...
                            <p class="text-sm mb-0">
                                ...
                                <span class="font-weight-bold ms-1">solicitudes </span>
                            </p>
                        </div>
                    </div>
                </div>
                <?php if (count($usuariosXhijo) > 0) : ?>
                    <?php foreach ($usuariosXhijo as $usuario) : ?>
                        <div class="row">
                                    ...
                                    <table class="table align-items-center mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <a type="button" onclick="aceptado(<?php echo $usuario['empleado'] ?>,<?php echo $usuario['diasSolicita'] ?>,<?php echo $usuario['hora'] ?>,<?php echo $usuario['minutos'] ?>,<?php echo $usuario['segundos'] ?>)"><i class="fas fa-check ms-auto text-success cursor-pointer"></i></a>
                                                </td>
                                                <td>
                                                    <a type="button" onclick="rechazado(<?php echo $usuario['empleado'] ?>,<?php echo $usuario['hora'] ?>,<?php echo $usuario['minutos'] ?>,<?php echo $usuario['segundos'] ?>)"><i " class=" fas fa-times ms-auto text-danger cursor-pointer"></i></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm">No existen solicitudes activas</h6>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
