<?php
require_once('./model/historialxPersona.php');
$historicoSolicitudes = historialxPersona::historialPersona($_SESSION["nombre"], $_SESSION["apellido"]);
?>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-7">
                            ...
                            <p class="text-sm mb-0">
                                ...
                                <span class="font-weight-bold ms-1">Tu</span>Historial
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        <div class="d-flex flex-column justify-content-center">
                                            <h6 class="mb-0 text-sm">No existen solicitudes pasadas</h6>
                                        </div>
                                    </div>
                                </td>
                            </tr>
